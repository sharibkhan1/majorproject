...
export function LogoCarouselDemo() {
  return (
    <section className="section-padding bg-[#111111] relative overflow-hidden">
              <div className="absolute -top-40 -left-40 w-80 h-80 bg-yellow-200/50 rounded-full filter blur-3xl"></div>
              <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-yellow-200/50 rounded-full filter blur-3xl"></div>

    <div className="space-y-8 bg-[#111111] py-24">
      <div className="mx-auto flex w-full max-w-screen-lg flex-col items-center space-y-8">
        ...
        <div className="text-center max-w-2xl mx-auto ">
          ...
          We use cutting-edge technologies to deliver innovative solutions that drive results
          </p>
        </div>
        </div>
